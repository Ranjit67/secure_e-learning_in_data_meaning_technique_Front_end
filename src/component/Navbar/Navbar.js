    ...
    return (
      <Axcious>
        <div className="Navbar">
          {this.state.homeMenuBoolean ? <Tabbox clas="navmodal" /> : null}
          {this.state.homeMenuBoolean ? (
            <Tabclose clas="navclose" closeEvent={this.homeMenuHandler} />
          ) : null}
          ...
          {this.state.avatarOverMouse || this.state.fixAvatarModal ? (
            <div
              onMouseOver={this.avatarHandler}
              onClick={this.clickFixedModal}
            >
              <Tabbox clas="avatarmodal" />
            </div>
          ) : null}
          ...
          <House
            className={Housetempclassmanger.join(" ")}
            onClick={this.homeMenuHandler}
          />

          <Dehaze
            className={Dehazetempclassmanager.join(" ")}
            onClick={this.homeMenuHandler}
          />
          ...
          <div className={searcContentadjest.join(" ")}>
            ...
            {this.state.inputBoolean ? (
              <button className="navbarSearch">search</button>
            ) : null}
          </div>
        </div>
      </Axcious>
